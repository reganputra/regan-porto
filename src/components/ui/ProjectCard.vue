...
<template>
  <a
    ...
    rel="noopener"
    :class="[
      'group block rounded-xl border border-border-subtle bg-surface-card overflow-hidden transition-all duration-300 hover:border-accent-dim/40 hover:bg-surface-hover',
